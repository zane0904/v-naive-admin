...
export const movePermissions = () => http.post(`${baseUrl}${Api.movePermissions}`)
// 获取手机号验证码
...
// 手机号登录
export const userPhoneLogin = (params: any) => http.post(`${baseUrl}${Api.userPhoneLogin}`, params)
// 用户名注册
export const register = (params: any) => http.post(`${baseUrl}${Api.useRegister}`, params)
// 找回密码
export const retrievePass = (params: any) => http.post(`${baseUrl}${Api.useRetrievePass}`, params)
// 角色列表
...
// 获取字典类别
export const getDIctTypeList = (params: Record<string, Object> | undefined) =>
  http.get(Api.ApiGetDIctTypeList, params)
