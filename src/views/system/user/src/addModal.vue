<template>
  <Modal @register="register" @ok="handleValidateButtonClick" @close="close" style="width: 800px">
    <div>
      <n-form ref="formRef" :model="model" :rules="rules" label-placement="left" label-width="80">
        <n-grid :cols="24" :x-gap="24">
          <n-form-item-gi :span="type === 'add' ? 12 : 24" label="用户名" path="userName">
            <n-input v-model:value="model.userName" placeholder="请输入登录用户名" />
          </n-form-item-gi>
          <n-form-item-gi v-if="type === 'add'" :span="12" label="密码" path="password">
            <n-input
