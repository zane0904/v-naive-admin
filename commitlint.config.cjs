...
module.exports = {
  ...
  type: [{ value: 'deps', name: 'deps:     项目依赖 🔗 Configure to package.json' }],
  prompt: {
    ...
    types: [
      ...
      { value: 'perf', name: 'perf:     性能提升 ⚡️ A code change that improves performance' },
      {
        value: 'test',
    ...
    customScopesAlias: '填写',
    emptyScopesAlias: '不填写',
